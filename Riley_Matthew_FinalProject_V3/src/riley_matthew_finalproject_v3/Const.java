...
public final class Const {
    ...
    public static final String BACKGROUND_URL = "Resources/Dirt_Terrain_Dark.png";
    ...
    public static final String BASE_URL = "Resources/Octagon_Base_V3.png";
    ...
    public static final int SIMPLE_BULLET_SPEED = 7;
    ...
    public static final double[] FIRE_RATE_TIMES = {0.30, 0.125, 1};
    ...
    public static final int GAME_OVER_DELAY = 12;
